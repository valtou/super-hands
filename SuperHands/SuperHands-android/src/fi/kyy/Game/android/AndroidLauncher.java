...
public class AndroidLauncher extends AndroidApplication implements
	...
	public void openFacebook() {
		try {
		    ...
		    Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("fb://profile/801152933239304"));
		    startActivity(i);
		   } catch (Exception e) {
		    Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/fi.adder"));
		    startActivity(i);
		   }
	}
